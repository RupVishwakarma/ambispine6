...
export default function ImgContRightHeroSection({ leftImg, rheading, rsubtitle, className }) {
  return (
    <div>
          <section className={ImgContentRight.imgRLcontentContainer}>
                  <div className={ImgContentRight.imgRLcontenMainContainer}>
                    ...
                    <div className={ImgContentRight.imgLContContainer}>
                      <h1 className={ImgContentRight.imgCheader}>
                        {rheading}
                      </h1>
                      <p className={ImgContentRight.imgCsubtitle}>
                      {rsubtitle}
                      </p>
