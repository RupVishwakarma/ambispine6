...
export default function DigitalMarketUpdate() {
  ...
  return (
    <div className='digital-market-update'>
        ...
        <ExploreHeroTechnologi heading="IOS APP DEVELOPMENT SERVICES"
     ...
     <div>
        <SecondSection heading="Let's Set Digital Marketing Goals & Objectives"
     ...
     <div className='Clicks-to-Conversion-Container'>
      ...
      <div  className='clicks-conversion-right'>
        <h3 className='clicks-conversion-right-header'>From Clicks to Conversions</h3>
        <p className='clicks-conversion-right-sub'>Digital Marketing MasteryWith Ambispine Technologies, discover the power of great work for your business. We help customize your products, brands, or services and ensure global visibility. Our tailored digital marketing strategies will help you stand out and reach your target audience effectively.</p>
      </div>
     </div>
       <SecondSection heading="Using Data to Inform Digital Marketing Decisions"
      ...
      />
         <ThirdSection heading="Staying Ahead of the Competition with Digital Marketing"
