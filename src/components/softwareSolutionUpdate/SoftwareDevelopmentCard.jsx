...
export default function SoftwareDevelopmentContainer() {
  ...
  return (
    <div className='soft-dev-process-container'>
          ...
          <p className='soft-dev-pro-sub'>We follow a structured approach to ensure successful project delivery</p>
 ...
 export function SoftwareDevelopmentCard({data1, heading='content'}) {
          ...
          <h4 className='soft-develop-sec-header'>{heading || "Default Heading"}</h4>
