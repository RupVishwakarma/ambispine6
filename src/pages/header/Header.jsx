    ...
    <header className={`header ${isScrolled ? "scrolled" : ""}`}>
      ...
      {/* <div
          ...
          >
            ...
            <div
              style={{ background: "#fff", marginTop: '23px' }}
          ...
          <div className="nav-item-dropdown"
            ...
            onMouseLeave={() => setIsDropdownOpen(false)}>
          <Link to="#" className="nav-link">
            Service <span className={`dropdown-arrow ${isDropdownOpen ? "open" : ""}`}>
                ▼
              </span>
          </Link>
          </div>
          <div onMouseEnter={() => setIsDropdownOpen(true)} onMouseLeave={() => setIsDropdownOpen(false)} style={{ background: "#fff" }} className={`dropdown-header-mega-services ${isDropdownOpen ? "productshow" : ""}`} >
            <div className="header-mega-services-left">
            <h3 className="services-dropdwon-heading">AmbiSpine Solution</h3>
            <p className="service-dropdwon-subtitle">Join us to discover the latest advancements in cloud. Computing artificial intelligence, and data analytics and be part of the transformation</p>
             <Link  to="/product"  className="network-learn-more-link dropdwon-product-explore" data-aos="fade-up"
               >
                Explore  Technologies<FaArrowRightLong className="" />
              </Link>
          </div>
          ...
          <Link to="#" className="nav-link">
            Product <span className={`dropdown-arrow ${isDropdownOpenProduct ? "open" : ""}`}>
                ▼
              </span>
          </Link>
          </div>
          <div onMouseEnter={() => setIsDropdownOpenProduct(true)} onMouseLeave={() => setIsDropdownOpenProduct(false)} style={{ background: "#fff" }} className={`dropdown-mega-product ${isDropdownOpenProduct ? "productshow" : ""}`} >
            <div className="service-solution-des">
            <h3 className="product-dropdwon-heading">AmbiSpine Solution</h3>
            <p className="product-dropdwon-subtitle">Join us to discover the latest advancements in cloud. Computing artificial intelligence, and data analytics and be part of the transformation</p>
             <Link  to="/product"  className="network-learn-more-link dropdwon-product-explore " data-aos="fade-up"
               >
                Explore Technologies <FaArrowRightLong className="" />
              </Link>
              ...
              productLink.map((data)=>{
                return(
                  <div key={data.id} className="my-2">
                    <Link className="product-drop-link" to={`product/${data.name.toLowerCase().replace(/\s+/g, "-")}`}>{data.name} <FaArrowRightLong className="product-lnk-icon"/></Link>
                  </div> 
                )
              })
            }
