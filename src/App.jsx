...
import AboutUpadate from './pages/AboutUpatePages/AboutUpadate'
...
import CmsUpate from "./components/CrmUpates/CmsUpate";
import CrmSolutionUpate from './components/CrmSolutionUpates/CrmSolutionUpate';
...
const PublicRoutes = () => (
  <Routes>
    ...
    <Route path='/aboutupdate' element={<AboutUpadate />} />
    ...
    />
    <Route path="/service/mobile-ios"
    element={<IOSMobileApp />}
    />
     <Route path="/service/mobile-and"
    ...
    <Route path="/digital-market-update" element={<DigitalMarketUpdate />} />
    <Route path="/explore-technologies" element={<ExploreTechnologi />} /> 
    <Route
      path="/services/web-designing-solution"
      element={<ResponsiveWebDesign />}
    />
    <Route path="/services/website-development" element={<WebDevelopment />} />
    <Route path="/services/webdevelopmentupdate" element={<WebDevelopmentupdate />} />
